...
After selecting rows in the table, the border of selected country will be highlighted in light blue. However, after filtering countries, the map will only keep the filtered countries and the other countries will appear black. The filtering function is dispalyed below.
